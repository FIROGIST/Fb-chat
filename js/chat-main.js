...
window.updateProfileDisplay = function(user) {
    ...
    const isSpoiled = currentUsername === 'BESO';
    ...
    if (isDev) {
        ...
        document.getElementById('userName').innerHTML = `${user.name} <span class="green-check">✓</span>`;
        document.getElementById('userUsername').innerHTML = `@${user.username} <span class="spoiled-badge">مغرورة</span>`;
    } else {
